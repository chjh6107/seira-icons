...
const LogoApple = ({ size = 24, ...props }: IconProps) => (
  <svg
  ...
  >
    ...
    <path d='M340.25 32c-24 1.63-52 16.91-68.4 36.86-14.88 18.08-27.12 44.9-22.32 70.91h1.92c25.56 0 51.72-15.39 67-35.11 14.72-18.77 25.88-45.37 21.8-72.66' />
  </svg>
);
