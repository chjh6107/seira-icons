...
const Newspaper = ({ size = 24, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d='M439.91 112h-23.82a.09.09 0 0 0-.09.09V416a32 32 0 0 0 32 32 32 32 0 0 0 32-32V152.09A40.09 40.09 0 0 0 439.91 112' />
