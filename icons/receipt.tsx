...
const Receipt = ({ size = 24, ...props }: IconProps) => (
  <svg
  ...
  >
    ...
    <path d='M336 424v-88a16 16 0 0 0-16-16H48a32.1 32.1 0 0 0-32 32.05c0 50.55 5.78 71.57 14.46 87.57C45.19 466.79 71.86 480 112 480h245.68a4 4 0 0 0 2.85-6.81C351.07 463.7 336 451 336 424' />
  </svg>
);
