...
const LogoInstagram = ({ size = 24, ...props }: IconProps) => (
  <svg
  ...
  >
    ...
    <path d='M377.33 162.67a28 28 0 1 1 28-28 27.94 27.94 0 0 1-28 28M256 181.33A74.67 74.67 0 1 1 181.33 256 74.75 74.75 0 0 1 256 181.33m0-37.33a112 112 0 1 0 112 112 112 112 0 0 0-112-112' />
  </svg>
);
