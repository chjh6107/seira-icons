...
const IceCreamSharp = ({ size = 24, ...props }: IconProps) => (
  <svg
  ...
  >
    ...
    <path d='M256 300v12a72.1 72.1 0 0 1-58.21 70.64L256 496l92.06-192.08a105.3 105.3 0 0 1-49.18-14.36A93.75 93.75 0 0 1 256 300' />
  </svg>
);
